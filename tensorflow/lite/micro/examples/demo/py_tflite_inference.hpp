#ifndef POCKET_AI_ENGINE_INFER_PY_TFLITE_INFERENCE_HPP_
#define POCKET_AI_ENGINE_INFER_PY_TFLITE_INFERENCE_HPP_
...
class PyTfliteInference {
public:
    void Init(std::string module_name, std::string class_name, std::string model_name) {
        class_name_ = class_name;

        pm_ = new PyManager();
        pm_->Init(module_name.c_str());
...
#endif // POCKET_AI_ENGINE_INFER_PY_TFLITE_INFERENCE_HPP_