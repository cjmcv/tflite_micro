...
// class UintTestFuncs {
// public:
//   static UintTestFuncs *GetInstance() {
//     static UintTestFuncs instance;
//     return &instance;
//   }
//   void Push(pTestFunc func) {
//     g_test_funcs.push_back(func);
//   }
//   int Call(int idx) {
//     return g_test_funcs[idx]();
//   }

// private:
//   UintTestFuncs() {}
//   std::vector<pTestFunc> g_test_funcs;
// };

#define TF_LITE_MICRO_TESTS_GLOBAL_VAR_DEF  \
  namespace micro_test {            \
  static int tests_passed;                 \
  static int tests_failed;                 \
  static bool is_test_complete;            \
  static bool did_test_fail;               \
  }

#define TF_LITE_MICRO_TESTS_BEGIN(func_name)   \
  int func_name() { \
    MicroPrintf("<<<<<<<<< Run %s >>>>>>>>>> ", #func_name); \
