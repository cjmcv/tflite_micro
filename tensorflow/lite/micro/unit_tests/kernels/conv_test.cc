...
#include "conv_test.h"
#include "testdata/conv_test_data.h"

#include "util/micro_test.h"
#include "util/kernel_runner.h"
...
TF_LITE_MICRO_TESTS_GLOBAL_VAR_DEF
...
TF_LITE_MICRO_TESTS_BEGIN(ConvTest)
